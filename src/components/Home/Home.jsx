    ...
    <>
      <section className="home px-lg-5 px-3 px-md-5 py-5 mt-5">
          ...
          <div className="row d-flex justify-content-between">
            <div className="right col-lg-6 col-md-6  col-12">
              ...
              <div className="search w-100 py-3 px-5 border-1 rounded-1 shadow mt-5 d-flex  align-items-center">
                ...
                <input type="search" className=" fa-search border-0 py-2 px-3" placeholder="Job tittle, Keyword..." />
                <button className="find Btn text-light"><Link className="link text-light" id="white" to={'/jops'}>Find Work</Link> </button>
              </div>
            </div>
        ...
        <section className="services container-fluid mt-5 px-lg-5 mb-5">
          <div className="row justify-content-between p">
       ...
       <div className="head d-flex justify-content-between mt-5 mb-5">
            ...
            <button className=" px-4 rounded py-1 bg-body">
              <a className=" text-decoration-none" href={'/courses'}>
                See all
              </a>
          ...
          <div className=" container-fluid " >
            <div className="row">
              <div className="box px-lg-2 p-1 col-lg-3 mb-2  col-md-6 col-12">
                 <div className="course m-1 ">
                  ...
                  <div className="details">
                    <h5>Course Name</h5>
                    <p>Your trusted platform for online learning, powering individuals to achieve their .</p>
                  </div>
                 </div>
        ...
        <section className="maps mt-5 px-lg-5">
        <div className="head d-flex justify-content-between mt-5 mb-5">
            <h4 className="hBold">Road Maps</h4>
            <button className=" px-4 rounded py-1 bg-body">
              <a className=" text-decoration-none" href={'/roadmaps'}>
                See all
              </a>
              <i class="fa-solid fa-arrow-right ms-2"></i>
            </button>
        ...
        <div className=" container-fluid ">
          <div className="row">
            <div className="box px-lg-3 p-1 col-lg-3 mb-2  col-md-4 col-6">
              <div className="map shadow p-3 rounded align-items-center< d-flex justify-content-between align-items-center">
        ...
        <section className="work mt-5 px-lg-5">
          <div className="head d-flex justify-content-between mt-5 mb-5">
            ...
            <button className=" px-4 rounded py-1 bg-body">
              <a className=" text-decoration-none" href={'/jops'}>
                See all
              </a>
              <i class="fa-solid fa-arrow-right ms-2"></i>
            </button>
          ...
          <div className="jops container-fluid ">
            <div className="row">
              <div className="box px-lg-2 p-1 col-lg-3 mb-2  col-md-6 col-12">
                <div className="jop shadow p-3 rounded-4 mb-3">
                  ...
                  <div className="details ms-2 mt-3">
                    ...
                    <p>
                      <span className=" text-dark ">Jop Time</span>
                      <div className="dot"></div>
                      <span>Full Time</span>
                    </p>
                  </div>
